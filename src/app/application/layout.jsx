        ...
        <section className="h-screen flex flex-col">
            ...
            <div className="p-6 font-bold text-primary flex-1 bg-white-primary border-2 border-t-0">
                ...
                <ul className="mt-12 text-lg">
                    ...
                    <a href=""><div className="flex items-center mb-10" ><BarChartBig/><li className="ml-2">Dashboards</li></div></a>
                    <a href=""><div className="flex items-center " ><LayoutGrid /> <li className="ml-2">Catálogo</li></div></a>
                </ul>
            </div>
        </section>
        <div className="w-full">
            <header className="w-full flex-1 bg-white-primary h-20 flex items-center">
            ...
            <main className="p-8 bg-body-bg">{children}</main>
        </div>
    </div>
    </>)
}